...
### How we do:
```html
<div id="4c9d39c82c3008cf5c9be0b17b01b03e" class="adlayer_space" style="height: 100px; width: 234px; position: absolute; clip: rect(0px 234px 100px 0px); "><embed src="http://xframe.adlayerjavascriptsdk.com.s3.amazonaws.com/as3.swf?src=http://dev.ads.adlayerapp.com/3/51634dee4a2442c39922c727ee58a4a5.swf?version=5167998cd504b&amp;callback=adlayer.markAdAsLoaded&amp;value=51634dee4a2442c39922c727ee58a4a5" height="500" width="500" type="application/x-shockwave-flash" allowscriptaccess="always" allownetworking="all" menu="false" wmode="transparent" scale="noscale" quality="high" id="51634dee4a2442c39922c727ee58a4a5"></div>
```
